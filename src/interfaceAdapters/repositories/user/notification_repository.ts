...
import {
  ...
  InputNotification,
  PaginatedNotificationRepo,
} from "../../../entities/repositoryInterface/user/notification_repository-interface";
import {
  INotificationModel,
  NotificationModel,
} from "../../../frameworks/database/models/notification_model";
import { BaseRepository } from "../baseRepo/base_repository";

@injectable()
export class NotificationRepository
  extends BaseRepository<INotificationModel, InputNotification>
  implements INotificationRepository
{
  ...
  async findByIdAndDelete(notificationId: string): Promise<void> {
